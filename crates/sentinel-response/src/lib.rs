...
pub enum ResponseAction {
    ...
    IsolateWorkload,
    LockArtifact,
    HoldArtifactDelivery,
    RouteToShadowAnalysis,
    QuarantineArtifact,
    ...
    EngageFastPathFusion,
    EnableFaultIsolatedEngines,
    ReserveStabilityHeadroom,
    ProtectFragileAssets,
    DistributeObservationLoad,
    BroadcastMeshAlert,
    ShiftGuardianCoverage,
    SuspendPeerTrust,
    EnableGuardianHandoff,
    AdoptFragilePeer,
    ShareMeshIntel,
    EnterShadowGatewayMode,
    ShieldWirelessManagementPlane,
    PinTrustedBackhaulLinks,
...
impl ResponseAction {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::HoldArtifactDelivery => "hold-artifact-delivery",
            Self::RouteToShadowAnalysis => "route-to-shadow-analysis",
            Self::QuarantineArtifact => "quarantine-artifact",
            ...
            Self::EngageFastPathFusion => "engage-fast-path-fusion",
            Self::EnableFaultIsolatedEngines => "enable-fault-isolated-engines",
            Self::ReserveStabilityHeadroom => "reserve-stability-headroom",
            Self::ProtectFragileAssets => "protect-fragile-assets",
            Self::DistributeObservationLoad => "distribute-observation-load",
            Self::BroadcastMeshAlert => "broadcast-mesh-alert",
            Self::ShiftGuardianCoverage => "shift-guardian-coverage",
            Self::SuspendPeerTrust => "suspend-peer-trust",
            Self::EnableGuardianHandoff => "enable-guardian-handoff",
            Self::AdoptFragilePeer => "adopt-fragile-peer",
            Self::ShareMeshIntel => "share-mesh-intel",
            Self::EnterShadowGatewayMode => "enter-shadow-gateway-mode",
            Self::ShieldWirelessManagementPlane => "shield-wireless-management-plane",
            Self::PinTrustedBackhaulLinks => "pin-trusted-backhaul-links",
