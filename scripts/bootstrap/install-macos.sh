...
CONFIG_ROOT="${CONFIG_ROOT:-$PREFIX/etc/crystalsentinel-arc}"
RULES_ROOT="${RULES_ROOT:-$CONFIG_ROOT/rules}"
STATE_ROOT="${STATE_ROOT:-$PREFIX/var/lib/crystalsentinel-arc}"
LOG_ROOT="${LOG_ROOT:-$PREFIX/var/log/crystalsentinel-arc}"
RUN_ROOT="${RUN_ROOT:-$PREFIX/var/run/crystalsentinel-arc}"
BIN_ROOT="${BIN_ROOT:-$PREFIX/bin}"
LIB_ROOT="${LIB_ROOT:-$PREFIX/lib}"

echo "Installing CrystalSentinel-ARC layout for macOS"
echo "  prefix:      $PREFIX"
